"===============Tuple==============="
# кортеж- неизменяемый ,индексируемый,упорядоченный,итерируемый тип данных,предназначенный для хранения любых данных в определенном порядке (в цлом не отличается от спиков бпросто неизменяемый поэтому занимает меньше памяти)
